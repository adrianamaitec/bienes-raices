            ...
            {!loading && (
                <div className="bg-white shadow overflow-hidden sm:rounded-md">
                                ...
                                <div className="px-4 py-4 sm:px-6 flex justify-between hover:bg-gray-50">
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="text-sm text-gray-500">{getAddress(department)}</p>
                                            <p className="text-sm text-gray-600">
                                                {department.size} m² • {department.bed} hab • {department.bathrooms} baños
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center space-x-2">
                                        <div className="text-right">
                                            <div className="text-lg font-bold">{formatPrice(department.price)}</div>
                                        </div>
                                        <Link
                    ...
                    {filteredDepartments.length === 0 && (
                        <div className="text-center py-10 text-gray-500">No se encontraron departamentos.</div>
                    )}
                </div>
            )}
            ...
            {showDeleteModal && (
                <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
                    <div className="bg-white p-6 rounded-lg shadow-lg">
                        <h2 className="text-lg font-semibold mb-2">Eliminar Departamento</h2>
                        <p className="text-sm text-gray-600 mb-4">
                            ¿Seguro que deseas eliminar este departamento? Esta acción no se puede deshacer.
                        </p>
